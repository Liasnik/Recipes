...
export default async function Carts() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-5 pt-10">
      ...
      <section className="w-full lg:w-[80%]  grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {carts &&
          carts.map((cart, index) => (
            <div
              key={cart?.id}
              className="p-5  border-[1px] bg-gray-900 rounded-xl border-gray-400 "
            >
